...
module.exports.validateCoordinates = (coord_to_validate) => {
   return isFinite(coord_to_validate) && Math.abs(coord_to_validate) <= 90 ? true : false;
};
/**
...
/**
 * @param  {} coverage_zone_to_validate
 */
module.exports.validateCoverageZone = (coverage_zone_to_validate) => {
   return coverage_zone_to_validate > 0 ? true : false;
};
/**
 * @param  {} time_to_validate
 */
module.exports.validateTime = (time_to_validate) => {
   return /^(2[0-3]|[0-1]?[\d]):[0-5][\d]:[0-5][\d]$/.test(time_to_validate) ? true : false;
};
/**
